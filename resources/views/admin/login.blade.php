...
@section('page-title')Авторизация администратора@endsection
    ...
    <div class="h-screen bg-white flex flex-col space-y-10 justify-center items-center">
        <div class="bg-white w-96 shadow-xl rounded p-5">
            ...
            <form method="POST" action="{{ route('admin.login_process') }}" class="space-y-5 mt-5">
                ...
                <input type="text" name="login" class="w-full h-12 border border-red-500 rounded px-3 @error('login') border-red-500 @enderror" placeholder="Логин" />
